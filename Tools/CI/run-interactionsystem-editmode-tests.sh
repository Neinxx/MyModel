...
ASSEMBLY_NAME="${1:-InteractionSystem.Editor.Tests}"
RESULT_FILE="$RESULT_DIR/interactionsystem-editmode-results.xml"
LOG_FILE="$RESULT_DIR/interactionsystem-editmode.log"
