...
ASSEMBLY_NAMES="${1:-ResourceManager.Tests,ResourceManager.Editor.Tests}"
RESULT_FILE="$RESULT_DIR/resource-manager-editmode-results.xml"
LOG_FILE="$RESULT_DIR/resource-manager-editmode.log"
